...
void MacMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->messageSize);
}
...
void MacMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->messageSize);
}

::omnetpp::simtime_t MacMessage::getTimeStamp() const
{
    return this->timeStamp;
}

void MacMessage::setTimeStamp(::omnetpp::simtime_t timeStamp)
{
    this->timeStamp = timeStamp;
}

int MacMessage::getSenderId() const
{
    return this->senderId;
}

void MacMessage::setSenderId(int senderId)
{
    this->senderId = senderId;
}

int MacMessage::getSeqno() const
{
    return this->seqno;
}

void MacMessage::setSeqno(int seqno)
{
    this->seqno = seqno;
}

int MacMessage::getMessageSize() const
{
    return this->messageSize;
}

void MacMessage::setMessageSize(int messageSize)
{
...
MacMessageDescriptor::MacMessageDescriptor() : omnetpp::cClassDescriptor("cosc418assignment::MacMessage", "omnetpp::cPacket")
{
...
int MacMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='m' && strcmp(fieldName, "messageSize")==0) return base+3;
...
std::string MacMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return long2string(pp->getMessageSize());
        default: return "";
    }
}
...
bool MacMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setMessageSize(string2long(value)); return true;
